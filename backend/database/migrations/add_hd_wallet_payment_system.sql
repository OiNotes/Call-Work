-- Migration: Add HD Wallet Payment System
-- Date: 2025-01-25
-- Description: Add invoices table for address-per-payment tracking using HD wallet (BIP44 derivation)
...
VALUES ('add_hd_wallet_payment_system')
